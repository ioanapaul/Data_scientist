# Déclaration de l'array contenant les handles Twitter
...
# Compter le nombre total de handles dans l'array
nombre_de_handles = handles.length

# Afficher le résultat
puts "Il y a #{nombre_de_handles} handles dans cette liste."
...
nombre_de_handles_5_caracteres = handles.count { |handle| handle.length == 6 }

# Afficher le resultat
puts " Il y a #{nombre_de_handles_5_caracteres} handles contenant 5 caractères." 

# Combien commencent par une majuscule, première lettre juste après le @ ?
nombre_de_handles_majuscule = handles.count { |handle| handle[1] == handle[1].upcase }

# Afficher le resultat
puts "Il y a #{nombre_de_handles_majuscule} handles commençant par une majuscule."

# Trie la liste de handle par ordre alphabétique.
nombre_de_handles_tries = handles.sort

# Afficher le resultat
puts " Voici la liste des handles triés par ordre alphabétique : #{nombre_de_handles_tries}."

# Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après).
nombre_de_handles_tries_taille = handles.sort_by(&:length)

# Afficher le resultat
puts " Voici la liste des handles triés par taille : #{nombre_de_handles_tries_taille}."
...
nombre_de_handles_par_taille =handles.group_by(&:length) && handles.sort_by(&:length).group_by(&:length)


# Afficher le resultat
puts " Voici la répartition des handles par taille : #{nombre_de_handles_par_taille}."
